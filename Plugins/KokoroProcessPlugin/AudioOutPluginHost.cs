...
{
    public class AudioOutPluginHost : ILatokonePluginHost
    {
    ...
    public class AudioOutPluginProcess : ILatokonePlugin
    {
        ILatokoneAI host;
        ...
        public AudioOutPluginProcess(ILatokoneAI host, string ipcID)
        {
            this.host = host;
            Name = ipcID;
            Type = PluginType.LatokonePluginType.TTS;
        ...
        public void Input(object txt)
        {
            sm.RemoteRequest(IPCMessage.CreateMessage((int)TtsPluginIPCMessageType.AddPartOfASentence, (string)txt));
        }
