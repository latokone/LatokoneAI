using LatokoneAI.Common.Audio.r8brain;


namespace LatokoneAI.Common.Audio
{
    public class RealTimeResampler
    {
        ...
        public void FillBuffer(Sample[] sampleDataTmp, int count)
        {
        ...
        public bool GetSamples(float[] outbuffer, int offset, int num)
        {
            bool canReadSamples = false;
